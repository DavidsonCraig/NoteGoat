...
describe("Accidentals should correct render given the keySignature prop", () => {
    ...
    it("Should render correct accidentals for BMaj", async () => {
        const contextSpy = jest.spyOn(rr, "useOutletContext")
        let mockdata = {keySignature: "BMaj"}
        contextSpy.mockReturnValue(mockdata)
        const {container} = render(
            <GrandStaff></GrandStaff>
        )
        ...
        expect(staffSharp3T.getAttribute("opacity")).toBe("1")
        expect(staffSharp4T.getAttribute("opacity")).toBe("1")
        expect(staffSharp5T.getAttribute("opacity")).toBe("1")
        expect(staffSharp6T.getAttribute("opacity")).toBe("0")
        expect(staffSharp7T.getAttribute("opacity")).toBe("0")
        ...
        expect(staffSharp3B.getAttribute("opacity")).toBe("1")
        expect(staffSharp4B.getAttribute("opacity")).toBe("1")
        expect(staffSharp5B.getAttribute("opacity")).toBe("1")
        expect(staffSharp6B.getAttribute("opacity")).toBe("0")
        expect(staffSharp7B.getAttribute("opacity")).toBe("0")
    ...
    it("Should render correct accidentals for FSharpMaj", async () => {
        const contextSpy = jest.spyOn(rr, "useOutletContext")
        let mockdata = {keySignature: "FSharpMaj"}
        contextSpy.mockReturnValue(mockdata)
        const {container} = render(
            <GrandStaff></GrandStaff>
        )
        ...
        expect(staffSharp4T.getAttribute("opacity")).toBe("1")
        expect(staffSharp5T.getAttribute("opacity")).toBe("1")
        expect(staffSharp6T.getAttribute("opacity")).toBe("1")
        expect(staffSharp7T.getAttribute("opacity")).toBe("0")
        ...
        expect(staffSharp4B.getAttribute("opacity")).toBe("1")
        expect(staffSharp5B.getAttribute("opacity")).toBe("1")
        expect(staffSharp6B.getAttribute("opacity")).toBe("1")
        expect(staffSharp7B.getAttribute("opacity")).toBe("0")
    ...
    it("Should render correct accidentals for CSharpMaj", async () => {
        const contextSpy = jest.spyOn(rr, "useOutletContext")
        let mockdata = {keySignature: "CSharpMaj"}
        contextSpy.mockReturnValue(mockdata)
        const {container} = render(
            <GrandStaff></GrandStaff>
        )
        ...
        expect(staffSharp5T.getAttribute("opacity")).toBe("1")
        expect(staffSharp6T.getAttribute("opacity")).toBe("1")
        expect(staffSharp7T.getAttribute("opacity")).toBe("1")
        ...
        expect(staffSharp5B.getAttribute("opacity")).toBe("1")
        expect(staffSharp6B.getAttribute("opacity")).toBe("1")
        expect(staffSharp7B.getAttribute("opacity")).toBe("1")
    ...
    it("Should render correct accidentals for FMaj", async () => {
        const contextSpy = jest.spyOn(rr, "useOutletContext")
        let mockdata = {keySignature: "FMaj"}
        contextSpy.mockReturnValue(mockdata)
        const {container} = render(
            <GrandStaff></GrandStaff>
        )
        ...
        expect(staffFlat1T.getAttribute("opacity")).toBe("1")
        expect(staffFlat2T.getAttribute("opacity")).toBe("0")
        expect(staffFlat3T.getAttribute("opacity")).toBe("0")
        expect(staffFlat4T.getAttribute("opacity")).toBe("0")
        expect(staffFlat5T.getAttribute("opacity")).toBe("0")
        ...
        expect(staffFlat1B.getAttribute("opacity")).toBe("1")
        expect(staffFlat2B.getAttribute("opacity")).toBe("0")
        expect(staffFlat3B.getAttribute("opacity")).toBe("0")
        expect(staffFlat4B.getAttribute("opacity")).toBe("0")
        expect(staffFlat5B.getAttribute("opacity")).toBe("0")
    ...
    it("Should render correct accidentals for BFlatMaj", async () => {
        const contextSpy = jest.spyOn(rr, "useOutletContext")
        let mockdata = {keySignature: "BFlatMaj"}
        contextSpy.mockReturnValue(mockdata)
        const {container} = render(
            <GrandStaff></GrandStaff>
        )
        ...
        expect(staffFlat1T.getAttribute("opacity")).toBe("1")
        expect(staffFlat2T.getAttribute("opacity")).toBe("1")
        expect(staffFlat3T.getAttribute("opacity")).toBe("0")
        expect(staffFlat4T.getAttribute("opacity")).toBe("0")
        expect(staffFlat5T.getAttribute("opacity")).toBe("0")
        expect(staffFlat6T.getAttribute("opacity")).toBe("0")
        ...
        expect(staffFlat1B.getAttribute("opacity")).toBe("1")
        expect(staffFlat2B.getAttribute("opacity")).toBe("1")
        expect(staffFlat3B.getAttribute("opacity")).toBe("0")
        expect(staffFlat4B.getAttribute("opacity")).toBe("0")
        expect(staffFlat5B.getAttribute("opacity")).toBe("0")
        expect(staffFlat6B.getAttribute("opacity")).toBe("0")
    ...
    it("Should render correct accidentals for EFlatMaj", async () => {
        const contextSpy = jest.spyOn(rr, "useOutletContext")
        let mockdata = {keySignature: "EFlatMaj"}
        contextSpy.mockReturnValue(mockdata)
        const {container} = render(
            <GrandStaff></GrandStaff>
        )
        ...
        expect(staffFlat1T.getAttribute("opacity")).toBe("1")
        expect(staffFlat2T.getAttribute("opacity")).toBe("1")
        expect(staffFlat3T.getAttribute("opacity")).toBe("1")
        expect(staffFlat4T.getAttribute("opacity")).toBe("0")
        expect(staffFlat5T.getAttribute("opacity")).toBe("0")
        expect(staffFlat6T.getAttribute("opacity")).toBe("0")
        expect(staffFlat7T.getAttribute("opacity")).toBe("0")
        ...
        expect(staffFlat1B.getAttribute("opacity")).toBe("1")
        expect(staffFlat2B.getAttribute("opacity")).toBe("1")
        expect(staffFlat3B.getAttribute("opacity")).toBe("1")
        expect(staffFlat4B.getAttribute("opacity")).toBe("0")
        expect(staffFlat5B.getAttribute("opacity")).toBe("0")
        expect(staffFlat6B.getAttribute("opacity")).toBe("0")
        expect(staffFlat7B.getAttribute("opacity")).toBe("0")
    ...
    it("Should render correct accidentals for AFlatMaj", async () => {
        const contextSpy = jest.spyOn(rr, "useOutletContext")
        let mockdata = {keySignature: "AFlatMaj"}
        contextSpy.mockReturnValue(mockdata)
        const {container} = render(
            <GrandStaff></GrandStaff>
        )
        ...
        expect(staffFlat2T.getAttribute("opacity")).toBe("1")
        expect(staffFlat3T.getAttribute("opacity")).toBe("1")
        expect(staffFlat4T.getAttribute("opacity")).toBe("1")
        expect(staffFlat5T.getAttribute("opacity")).toBe("0")
        expect(staffFlat6T.getAttribute("opacity")).toBe("0")
        expect(staffFlat7T.getAttribute("opacity")).toBe("0")
        ...
        expect(staffFlat2B.getAttribute("opacity")).toBe("1")
        expect(staffFlat3B.getAttribute("opacity")).toBe("1")
        expect(staffFlat4B.getAttribute("opacity")).toBe("1")
        expect(staffFlat5B.getAttribute("opacity")).toBe("0")
        expect(staffFlat6B.getAttribute("opacity")).toBe("0")
        expect(staffFlat7B.getAttribute("opacity")).toBe("0")
    ...
    it("Should render correct accidentals for DFlatMaj", async () => {
        const contextSpy = jest.spyOn(rr, "useOutletContext")
        let mockdata = {keySignature: "DFlatMaj"}
        contextSpy.mockReturnValue(mockdata)
        const {container} = render(
            <GrandStaff></GrandStaff>
        )
        ...
        expect(staffFlat3T.getAttribute("opacity")).toBe("1")
        expect(staffFlat4T.getAttribute("opacity")).toBe("1")
        expect(staffFlat5T.getAttribute("opacity")).toBe("1")
        expect(staffFlat6T.getAttribute("opacity")).toBe("0")
        expect(staffFlat7T.getAttribute("opacity")).toBe("0")
        ...
        expect(staffFlat3B.getAttribute("opacity")).toBe("1")
        expect(staffFlat4B.getAttribute("opacity")).toBe("1")
        expect(staffFlat5B.getAttribute("opacity")).toBe("1")
        expect(staffFlat6B.getAttribute("opacity")).toBe("0")
        expect(staffFlat7B.getAttribute("opacity")).toBe("0")
    ...
    it("Should render correct accidentals for GFlatMaj", async () => {
        const contextSpy = jest.spyOn(rr, "useOutletContext")
        let mockdata = {keySignature: "GFlatMaj"}
        contextSpy.mockReturnValue(mockdata)
        const {container} = render(
            <GrandStaff></GrandStaff>
        )
        ...
        expect(staffFlat4T.getAttribute("opacity")).toBe("1")
        expect(staffFlat5T.getAttribute("opacity")).toBe("1")
        expect(staffFlat6T.getAttribute("opacity")).toBe("1")
        expect(staffFlat7T.getAttribute("opacity")).toBe("0")
        ...
        expect(staffFlat4B.getAttribute("opacity")).toBe("1")
        expect(staffFlat5B.getAttribute("opacity")).toBe("1")
        expect(staffFlat6B.getAttribute("opacity")).toBe("1")
        expect(staffFlat7B.getAttribute("opacity")).toBe("0")
    
        contextSpy.mockRestore()
    })

    it("Should render correct accidentals for CFlatMaj", async () => {
        const contextSpy = jest.spyOn(rr, "useOutletContext")
        let mockdata = {keySignature: "CFlatMaj"}
        contextSpy.mockReturnValue(mockdata)
        const {container} = render(
            <GrandStaff></GrandStaff>
        )
        ...
        expect(staffFlat5T.getAttribute("opacity")).toBe("1")
        expect(staffFlat6T.getAttribute("opacity")).toBe("1")
        expect(staffFlat7T.getAttribute("opacity")).toBe("1")
        ...
        expect(staffFlat5B.getAttribute("opacity")).toBe("1")
        expect(staffFlat6B.getAttribute("opacity")).toBe("1")
        expect(staffFlat7B.getAttribute("opacity")).toBe("1")
